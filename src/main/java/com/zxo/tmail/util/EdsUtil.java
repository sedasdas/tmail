...
public class EdsUtil {
     ...
     *
     */
    public static String decryptBasedDes(String password) {
        ...
        try {
            ...
            decryptedData = new String(cipher.doFinal(new sun.misc.BASE64Decoder().decodeBuffer(password)));
        } catch (Exception e) {
